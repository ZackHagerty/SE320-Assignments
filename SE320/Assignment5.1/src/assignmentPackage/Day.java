//Utilizes second "Day" class implementation from class
//because this project only requires date arithmetic. The 
//depth of third implementation is not strictly necessary
